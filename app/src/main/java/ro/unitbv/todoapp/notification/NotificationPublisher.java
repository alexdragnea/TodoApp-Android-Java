package ro.unitbv.todoapp.notification;

import static ro.unitbv.todoapp.ReminderActivity.NOTIFICATION_CHANNEL_ID;
...
import ro.unitbv.todoapp.NotificationMessage;
import ro.unitbv.todoapp.R;
...
//  }
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    contentView.setImageViewResource(com.airbnb.lottie.R.id.image, R.mipmap.ic_launcher);
